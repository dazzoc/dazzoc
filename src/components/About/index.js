...
import { AboutContainer, AboutBg, AboutContent, Top2, Box2, StarIconAbout, AboutTitle, Row1, Column1, Column2, Descrip, Row2, Name, Title, FunkStar, Info, Bio, BioTitle, ArrowDown1 } from './AboutElements';
